...
static boolean ancestor(String x, String y, Map<String, String> parent) {
    for (String p = parent.get(y); p != null; p = parent.get(p))
...
static boolean answerQuery(String statement, Map<String, String> parent) {
    ...
    if (statement.contains(" is a child of "))
        return y.equals(parent.get(x));
    if (statement.contains(" is the parent of "))
        return x.equals(parent.get(y));
