...
public class Main {
    ...
    static ArrayListData MakeEmpty() { return new ArrayListData(); }
    ...
    static boolean Insert(ArrayListData L, int x, int p) {
        if (L.last + 1 == MAXSIZE) { System.out.print("FULL"); return false; }
        if (p < 0 || p > L.last + 1) { System.out.print("ILLEGAL POSITION"); return false; }
    ...
    static boolean Delete(ArrayListData L, int p) {
        if (p < 0 || p > L.last) { System.out.print("POSITION " + p + " EMPTY"); return false; }
